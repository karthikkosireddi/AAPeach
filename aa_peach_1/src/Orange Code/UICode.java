...
public class UICode extends javax.swing.JFrame {
    ...
    public UICode() {
        ...
        // Set JFrame main window settings
         // [KK] Need to move to our images directory
         setIconImage((new ImageIcon("logo-anyaut-small.png")).getImage());
       ...
       this.getContentPane().setBackground(new java.awt.Color(255, 255, 255));
        ...
        // Window Title
        JTextField newTitle = new JTextField("AnyAUT.com : Write Manual, Run Selenium.");
        ...
        chooseExcelFile.setDialogTitle("Select the Excel file exported from AnyAUT.");
        ...
        labelCopyright.setText("Copyright 2017. www.AnyAUT.com. A varkasa Inc Product.");

        //set images
        logoAnyAUT.setIcon(new javax.swing.ImageIcon("logo-anyaut-small.png")); // NOI18N
        ...
        String vTT3 =
                "<html><p><font color=\"#000\" " +
                "size=\"18\" face=\"Calibri\">Excel exported from AnyAUT" +
                "</font></p></html>";
        ...
        // vTestRunName.setToolTipText("Give it a name.");
    ...
    private void buttonBrowseXLActionPerformed(java.awt.event.ActionEvent evt) {                                                
        ...
        //int returnValue = chooseExcelFile.showOpenDialog((Component)evt.getSource());
