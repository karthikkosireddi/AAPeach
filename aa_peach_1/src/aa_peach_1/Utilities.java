 ...
 * Date: 11/11/2016
 * Purpose: 1. Merged the Excel utilities in to this class
 * 			1. Created a new method to obtain the absolute path of the current working directory 	
 */
...
/*	public static void writeXL(String fPath, String fSheet, String[][] xData) throws Exception{
	...
	/* Updated by : Aparna 
	 * Date : Oct 26 2016
	 * Reason: These functions are to create multiple sheets and cell formatting .
	 * Added headingcellformat , datacellformat , passedcellformat , failedcellformat and
	 * writeXLSheets method
	 *  */
